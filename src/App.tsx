      ...
      <Layout
        ...
        detail={
          selectedPrompt ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-text-primary/60 gap-3 px-6 text-center">
              <svg className="w-10 h-10 text-text-primary/25" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <p className="text-sm">从左侧选择一个提示词查看详情</p>
              <p className="text-xs text-text-primary/45">或点击左上角「新建提示词」开始创建</p>
            </div>
          )
        }
      />
